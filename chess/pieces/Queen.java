...
public class Queen extends ChessPiece {
	...
	public Queen(String color, int row, int col) {
		super(color, row, col);
		super.setTransparentImage(new ImageIcon(System.getProperty("user.dir")+"\\chess\\images\\"+getColor()+"Queen.png").getImage());
	} 
...
//		}
	...
	public Image getImage() {
		return new ImageIcon(System.getProperty("user.dir")+"\\chess\\images\\"+getColor()+"Queen"+getBlackOrWhiteTile()+"Tile.png").getImage();
	}
